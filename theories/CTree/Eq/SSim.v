...
|*)
  ...
  (*|
    ...
    |*)
  Lemma step_ss_brS_gen {Y n m} (k : fin' n -> ctree E X) (k' : fin' m -> ctree F Y)
    (R L: rel _ _) :
    (Proper (equ eq ==> equ eq ==> impl) R) ->
    (forall x, exists y, R (k x) (k' y)) ->
    L tau tau ->
    ss L R (BrS n k) (BrS m k').
  Proof.
    intros PROP EQs ? ? ? TR.
    apply trans_brS_inv in TR as (? & ? & ->).
  ...
  Lemma step_ss_brS {Y n m} (k : fin' n -> ctree E X) (k' : fin' m -> ctree F Y)
    (R L: rel _ _) :
    (forall x, exists y, sst L R (k x) (k' y)) ->
    L tau tau ->
    ssbt L R (BrS n k) (BrS m k').
  Proof.
    intros.
  ...
  Lemma ssim_brS {Y n m} (k : fin' n -> ctree E X) (k' : fin' m -> ctree F Y) (L: rel _ _) :
    (forall x, exists y, ssim L (k x) (k' y)) ->
    L tau tau ->
    ssim L (BrS n k) (BrS m k').
  Proof.
    intros. step. now apply step_ss_brS.
  Qed.

  Lemma step_ss_brS_id_gen {Y n} (k: fin' n -> ctree E X) (k': fin' n -> ctree F Y)
    (R L : rel _ _) :
    (Proper (equ eq ==> equ eq ==> impl) R) ->
    (forall x, exists y, R (k x) (k' y)) ->
    L tau tau ->
    ss L R (BrS n k) (BrS n k').
  Proof.
    intros; apply step_ss_brS_gen; eauto.
  Qed.

  Lemma step_ss_brS_id {Y n} (k: fin' n -> ctree E X) (k': fin' n -> ctree F Y) (R L : rel _ _) :
    (forall x, exists y, sst L R (k x) (k' y)) ->
    L tau tau ->
    ssbt L R (BrS n k) (BrS n k').
  Proof.
    intros.
  ...
  Lemma ssim_brS_id {Y n} (k: fin' n -> ctree E X) (k': fin' n -> ctree F Y) (L : rel _ _) :
    (forall x, exists y, ssim L (k x) (k' y)) ->
    L tau tau ->
    ssim L (BrS n k) (BrS n k').
  Proof.
  ...
  Lemma step_ss_brD_l_gen {Y n} (k : fin' n -> ctree E X) (t': ctree F Y) (R L: rel _ _):
  ...
  Proof.
    ...
    apply EQs in TR; destruct TR as (l' & u' & TR').
    exists l', u'; auto.
  Qed.

  Lemma step_ss_brD_l {Y n} (k : fin' n -> ctree E X) (t: ctree F Y) (R L: rel _ _):
  ...
  Lemma ssim_brD_l {Y n} (k : fin' n -> ctree E X) (t: ctree F Y) (L: rel _ _):
  ...
  Lemma step_ss_brD_r_gen {Y n} x (k : fin' n -> ctree F Y) (t: ctree E X) (R L: rel _ _):
    ss L R t (k x) ->
    ss L R t (BrD n k).
  Proof.
    cbn. intros.
  ...
  Lemma step_ss_brD_r {Y n} x (k : fin' n -> ctree F Y) (t: ctree E X) (R L: rel _ _):
    ssbt L R t (k x) ->
    ssbt L R t (BrD n k).
  Proof.
  ...
  Lemma ssim_brD_r {Y n} x
        (k : fin' n -> ctree F Y) (t: ctree E X) (L: rel _ _):
    ssim L t (k x) ->
    ssim L t (BrD n k).
  Proof.
  ...
  Lemma step_ss_brD_gen {Y n m} 
    (k : fin' n -> ctree E X) (k' : fin' m -> ctree F Y) (R L : rel _ _) :
    (forall x, exists y, ss L R (k x) (k' y)) ->
    ss L R (BrD n k) (BrD m k').
  Proof.
    intros EQs.
    apply step_ss_brD_l_gen.
  ...
  Lemma step_ss_brD {Y n m} (k: fin' n -> ctree E X) (k' : fin' m -> ctree F Y) (L R : rel _ _) :
    (forall x, exists y, ssbt L R (k x) (k' y)) ->
    ssbt L R (BrD n k) (BrD m k').
  Proof.
    apply step_ss_brD_gen.
  Qed.

  Lemma ssim_brD {Y n m} (k : fin' n -> ctree E X) (k': fin' m -> ctree F Y) (L : rel _ _) :
    (forall x, exists y, ssim L (k x) (k' y)) ->
    ssim L (BrD n k) (BrD m k').
  Proof.
    intros. step. apply step_ss_brD.
    intros. destruct (H x). step in H0. exists x0. apply H0.
  Qed.

  Lemma step_ss_brD_id_gen {Y n m} (k : fin' n -> ctree E X) (k' : fin' m -> ctree F Y)
        (R L : rel _ _) :
    (forall x, exists y, ss L R (k x) (k' y)) ->
    ss L R (BrD n k) (BrD m k').
  Proof.
  ...
  Lemma step_ss_brD_id {Y n m} (k: fin' n -> ctree E X) (k': fin' m -> ctree F Y) (R L: rel _ _) :
    (forall x, exists y, ssbt L R (k x) (k' y)) ->
    ssbt L R (BrD n k) (BrD m k').
  Proof.
  ...
  Lemma ssim_brD_id {Y n m} (k: fin' n -> ctree E X) (k': fin' m -> ctree F Y) (L: rel _ _) :
    (forall x, exists y, ssim L (k x) (k' y)) ->
    ssim L (BrD n k) (BrD m k').
  Proof.
  ...
  Lemma ssim_brS_inv {Y n m} {L: rel (label E) (label F)}
    (k1 : fin' n -> ctree E X) (k2 : fin' m -> ctree F Y) :
    ssim L (BrS n k1) (BrS m k2) ->
  ...
  Lemma ss_brD_l_inv {Y n} {L: rel (label E) (label F)}
    (t : ctree F Y) (k : fin' n -> ctree E X) R:
    ss L R (BrD n k) t ->
    forall x, ss L R (k x) t.
  Proof.
    cbn. intros.
  ...
  Lemma ssim_brD_l_inv {Y n} {L: rel (label E) (label F)}
    (t : ctree F Y) (k : fin' n -> ctree E X):
    ssim L (BrD n k) t ->
    forall x, ssim L (k x) t.
  Proof.
  ...
  Lemma ssim_brD_r_inv {Y n} {L: rel (label E) (label F)}
    (t : ctree E X) (k : fin' n -> ctree F Y):
    ssim L t (BrD n k) ->
    forall l t', trans l t t' ->
    exists l' x t'' , trans l' (k x) t'' /\ L l l' /\ (ssim L t' t'').
  Proof.
    cbn. intros. step in H. apply H in H0 as (? & ? & ? & ? & ?); subst.
    trans in H0.
    exists x, n0, x0; auto.
  Qed.
